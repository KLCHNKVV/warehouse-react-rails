...
(function() {
  this.Product = React.createClass;

  ({
    render: function() {
      return React.DOM.tr(null, React.DOM.td(null, this.props.product.product_type), React.DOM.td(null, this.props.product.brand), React.DOM.td(null, this.props.product.product_model_name), React.DOM.td(null, priceFormat(this.props.product.price)));
    }
  });

}).call(this);
(function() {
  this.Products = React.createClass({
    getInitialState: function() {
      return {
    ...
    render: function() {
      ...
      }, React.DOM.thead(null, React.DOM.tr(null, React.DOM.th(null, 'Product type'), React.DOM.th(null, 'Brand'), React.DOM.th(null, 'Product model name'), React.DOM.th(null, 'Price'))), React.DOM.tbody(null, (function() {
        var i, len, ref, results;
        ref = this.state.products;
        results = [];
